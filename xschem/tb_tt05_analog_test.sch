...
device=resistor
m=1}
C {devices/vsource.sym} 460 -230 0 0 {name=Vdd1 value="0 pwl(0 0 10u 0 10.01u 1.8)"

}
C {/foss/designs/xschem/tt05_analog_test.sym} 1640 -730 0 0 {name=x1}
